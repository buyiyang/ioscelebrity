...
class MeetOrderDetailVC: BaseTableViewController {
    ...
    func initUI() {
        headerImage.kf.setImage(with: URL(string:qiniuHelper.shared().qiniuHeader +  model.head_url_tail), placeholder: UIImage.imageWith(AppConst.iconFontName.newsPlaceHolder.rawValue, fontSize: CGSize.init(width: 40, height: 40), fontColor: UIColor.init(rgbHex: AppConst.ColorKey.main.rawValue)))
